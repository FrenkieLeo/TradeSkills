...
- [x] NDX-01：AAPL, ABNB, ADBE, ADI, ADP, ADSK, AEP, ALNY, AMAT, AMD, AMGN, AMZN, APP, ARM, ASML, AVGO, AXON, BKNG, BKR, CCEP
- [x] NDX-02：CDNS, CEG, CMCSA, COST, CPRT, CRWD, CSCO, CSX, CTAS, DASH, DDOG, DXCM, EA, EXC, FANG, FAST, FER, FTNT, GEHC, GILD
- [x] NDX-03：GOOG/GOOGL（同一公司合并研究）, HON, HONA, IDXX, INSM（2026-06移除，保留过渡档案）, INTC, INTU, ISRG, KDP, KHC, KLAC, LIN, LITE, LRCX, MAR, MCHP, MDLZ, MELI, META, MNST
- [x] NDX-04：MPWR, MRVL, MSFT, MSTR, MU, NBIS, NFLX, NVDA, NXPI, ODFL, ORLY, PANW, PAYX, PCAR, PDD, PEP, PLTR, PYPL, QCOM, REGN
- [x] NDX-05：RKLB, ROP, ROST, SBUX, SHOP, SNDK, SNPS, SPCX, STX, TER, TMUS, TRI, TSLA, TTWO, TXN, VRTX, WBD, WDAY, WDC
- [x] NDX-06：ALAB, CRWV, WMT, XEL，以及成分变动复核与遗漏检查（TEAM、INSM已移除）
...
- [x] NDX L2-05：CDNS, CEG, CMCSA, COST, CPRT
- [ ] NDX L2-06：CRWD, CSCO, CSX, CTAS, DASH
- [ ] NDX L2-07：DDOG, DXCM, EA, EXC, FANG
- [ ] NDX L2-08：FAST, FER, FTNT, GEHC, GILD
- [ ] NDX L2-09：GOOG/GOOGL（同一公司）, HON, HONA, IDXX, INTC
- [ ] NDX L2-10：INTU, ISRG, KDP, KHC, KLAC
- [ ] NDX L2-11：LIN, LITE, LRCX, MAR, MCHP
- [ ] NDX L2-12：MDLZ, MELI, META, MNST, MPWR
- [ ] NDX L2-13：MRVL, MSFT, MSTR, MU, NBIS
- [ ] NDX L2-14：NFLX, NVDA, NXPI, ODFL, ORLY
- [ ] NDX L2-15：PANW, PAYX, PCAR, PDD, PEP
- [ ] NDX L2-16：PLTR, PYPL, QCOM, REGN, RKLB
- [ ] NDX L2-17：ROP, ROST, SBUX, SHOP, SNDK
- [ ] NDX L2-18：SNPS, SPCX, STX, TER, TMUS
- [ ] NDX L2-19：TRI, TSLA, TTWO, TXN, VRTX
- [ ] NDX L2-20：WBD, WDAY, WDC, ALAB, CRWV
- [ ] NDX L2-21：WMT, XEL
